...
from neuralTrack.loss.dscLoss import dsc_loss
...
dsc_loss_func  = partial(dsc_loss, delta_v=0.5, delta_d=2, norm=2)
...
trainer = SegFFNNetTrainer(model, criterion, metric_func, args.fov_shape, device=device)
