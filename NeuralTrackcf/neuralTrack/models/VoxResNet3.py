...
class VoxResNet_3D(nn.Module):
    def __init__(self,in_ch,out_ch,act_fn=nn.ReLU(inplace=True)):
        ...
        self.res2=Res_Module(64,act_fn)
        self.res3=Res_Module(64,act_fn)
        ...
        self.res5=Res_Module(64,act_fn)
        self.res6=Res_Module(64,act_fn)
        ...
        self.res8=Res_Module(64,act_fn)
        self.res9=Res_Module(64,act_fn)
