...
# Longestpath.m:3
    StartNode=CurrVec(arange(),PointId)
# Longestpath.m:4
    CurrVec[4,PointId]=1
# Longestpath.m:5
...
# Longestpath.m:10
    kk=1
# Longestpath.m:11
    Curves[arange(),kk]=StartNode(arange(1,3))
# Longestpath.m:12
...
# Longestpath.m:18
        PointId0=Longestpathsub(SS,PointId,2,CurrVec(4,arange()))
# Longestpath.m:20
...
# Longestpath.m:23
            kk=kk + 1
# Longestpath.m:24
            Curves[arange(),kk]=CurrVec(arange(1,3),PointId0)
# Longestpath.m:25
...
# Longestpath.m:31
    ...
    if kk > 1:
        Curves=Curves(arange(),arange(1,kk))
# Longestpath.m:42
        ExtraLabel=ExtraLabel(arange(),arange(1,kk))
# Longestpath.m:43
    else:
        Curves=[]
# Longestpath.m:45
