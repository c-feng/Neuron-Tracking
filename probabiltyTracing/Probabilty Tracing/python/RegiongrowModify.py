...
from libsmop import *
# RegiongrowModify.m
from RegiongrowsubModify import RegiongrowsubModify
from weigthvalue import weigthvalue
import pdb
...
# RegiongrowModify.m:12
        if isempty(Currdata) == 0:
            Dataset[:, arange(kk + 1,kk + size(Currdata,2))]=Currdata[:, arange(1, size(Currdata,2))]
...
# RegiongrowModify.m:32
    return Dataset, datacell, ImgBinary0