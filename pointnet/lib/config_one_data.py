...
__C.DATAPATH = "/home/fcheng/Neuron/pointnet/data/syn_data_FPS_32768/"
__C.AUGMENT = True
...
__C.TRAIN.DECAY_STEP_LIST = [500, 800] #[100, 200, 250, 300]
...
__C.TRAIN.BN_DECAY_STEP_LIST = [500, 800]
...
# __C.NET.SA_NPOINTS = [8192, 2048, 512, 128]
# __C.NET.RADIIS = [[0.1, 0.5], [0.5, 1.], [1.0, 2.0], [2.0, 4.0]]
# __C.NET.NSAMPLES = [[16, 32], [16, 32], [16, 32], [16, 32]]
# __C.NET.MLPS = [[[16, 16, 32], [32, 32, 64]],
#                 [[64, 64, 128], [64, 96, 128]],
